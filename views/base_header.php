...
<head>
	...
	<title><?php echo $title=isset($title)?$title:'Prueba_Konecta'; ?></title>
...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark bg-blue nav-bar">
  		<a class="navbar-brand list-items" href="index.php"><strong>Cafetería Konecta</strong></a>
